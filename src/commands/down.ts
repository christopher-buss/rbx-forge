...
import type { StoppedBy } from "../client/down.ts";
 ...
 * @returns The stopped session's id, how it stopped, and any cleanup.
...
export async function runDownAsync(
	...
	return {
		...
		summary: `${HOW[report.stoppedBy]} ${report.sessionId}; every process of it is gone.`,
	};
}
